...
Version: 1.0 2022
Implementation in Python 3.8, the codes for the Prototype of Smart Cam to contribute to reduce the criminal assaults and dangerous situations lived in real time in the interior of Stores, Shops or local business in our City. 

What is the version 1.0:
+ We have a Dataset with thousands of images bout the signals than we want to detect in the next part of the Algorithm using IA. 
